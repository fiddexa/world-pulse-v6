...
AROUND THE MAIN publishes **3 EDITIONS DAILY**.

The publication has three internal daily release slots, but the internal production schedule is deliberately separated from the public visual identity.

### Internal production schedule

The technical production system continues to operate in:
...
These times remain internal technical slots for:

- watchdog scheduling;
- due-edition detection;
- Editorial Snapshot timing;
- retries and recovery;
- idempotency and duplicate protection;
- persistent Edition ID and delivery state.

The internal slot must not be treated as a public edition name.

### Public presentation

The public product is presented simply as:

```text
3 EDITIONS DAILY
```

Public page design must **not** display:
...
Edition identity is communicated through:
...
A delayed publication does not change the public edition identity. A technical slot may execute later than its nominal schedule because of processing, recovery or operational delay; the public design remains neutral.

### Edition sequence

The three daily editions remain independent editorial snapshots:

```text
Internal slot 1 → Edition XXXX
Internal slot 2 → Edition XXXX
Internal slot 3 → Edition XXXX
```

The exact public edition number is generated by the existing edition-numbering system. Internal slot information remains available to production logic and persistent state.

### Product identity

The public visual language should communicate:

> **3 EDITIONS DAILY**

rather than a sequence of named dayparts.

The edition number, publication date and page number remain visible and stable across the printed/mobile presentation.
...
### Public Edition Identity

The public presentation is neutral and does not expose the internal release slot.
...
The visual system must not display:
...
The header must not contain a baked-in daypart label.
...
The footer is part of the public product identity and must not expose the internal publication schedule.

The Page 01 footer must prominently communicate:

```text
3 EDITIONS DAILY
```

The footer may retain the established AROUND THE MAIN branding, support/contact elements and visual system, but must not contain the three internal times or named dayparts.
