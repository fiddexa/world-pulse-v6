...
def render_section_page(
    ...
    """
    Render a compact newspaper-style section page.

    The page receives its own EditionPage object and renders only
    the events assigned to that page.

    Layout is intentionally editorial rather than screen-filling:
    stories use compact newspaper blocks instead of giant empty cards.
    """
    ...
    if event_count == 0:
        ...
        # One story gets a strong but compact newspaper treatment.
        _draw_story(
            events[0],
            (
                MARGIN,
        ...
        # TWO STORIES
        #
        # Compact horizontal newspaper articles.
        # No giant empty vertical cards.
        # ------------------------------------------------------------
        ...
        # THREE STORIES
        #
        # Lead story across the page, then two compact columns.
        # ------------------------------------------------------------
