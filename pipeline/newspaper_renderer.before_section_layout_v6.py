...
def render_section_page(
    ...
    page_number = int(
        _page_attr(page, "page_number", 2)
        or 2
    )

    title = _safe_text(
        _page_attr(page, "title", "")
    )
    ...
    content_top = _draw_section_title(
        draw,
        title,
        content_top,
    )
    ...
    if not events:
        draw.text(
            (MARGIN, content_top + 30),
            "NO PUBLISHED STORIES",
            font=_font(22, bold=True),
            fill=GRAY,
        )

        _draw_section_footer(draw)
    ...
    # ================================================================
    # 1 STORY — dominant newspaper article
    # ================================================================
    if count == 1:
        event = events[0]
        ...
        _draw_article(
            ...
            1,
            lead=True,
            image_height=480 if _section_has_image(event) else None,
        )

    # ================================================================
    # 2 STORIES — asymmetric newspaper spread
    # ================================================================
    elif count == 2:
        gap = 22
        left_width = int(CONTENT_WIDTH * 0.62)
        right_width = CONTENT_WIDTH - left_width - gap

        x1 = MARGIN
        x2 = MARGIN + left_width + gap
        y = content_top + 15
        ...
        _draw_article(
            ...
            1,
            lead=True,
            image_height=430 if _section_has_image(events[0]) else None,
        )
        ...
        _draw_article(
            ...
            2,
            lead=False,
            image_height=250 if _section_has_image(events[1]) else None,
        )

    # ================================================================
    # 3 STORIES — lead + two stacked side stories
    # ================================================================
    elif count == 3:
        gap = 22
        left_width = int(CONTENT_WIDTH * 0.62)
        ...
        _draw_article(
            ...
            1,
            lead=True,
            image_height=440 if _section_has_image(events[0]) else None,
        )
        ...
        _draw_article(
            ...
            side_height,
            2,
            image_height=220 if _section_has_image(events[1]) else None,
        )
        ...
        _draw_article(
            ...
            side_height,
            3,
            image_height=220 if _section_has_image(events[2]) else None,
        )

    # ================================================================
    # 4 STORIES — two large upper stories + compact lower row
    # ================================================================
    elif count == 4:
        gap = 22
        ...
        _draw_article(
            ...
            1,
            lead=True,
            image_height=280 if _section_has_image(events[0]) else None,
        )
        ...
        _draw_article(
            ...
            2,
            lead=True,
            image_height=280 if _section_has_image(events[1]) else None,
        )

        lower_y = y + row_height + 38
    ...
    # ================================================================
    # 5+ STORIES — dense newspaper grid
    # ================================================================
    else:
        gap = 18
        col_width = int(
        ...
        current_y = content_top + 12
        index = 0
        row = 0

        while index < count and current_y < content_bottom - 180:
    ...
    if count >= 5:
        ...
        remaining_briefs = events[brief_start:]
        ...
        if remaining_briefs:
            ...
            for offset, event in enumerate(
                ...
                title_text = _section_event_title(event)
